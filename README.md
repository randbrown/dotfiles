# randbrown does dotfiles - forked from holman's repo

### WSL Configuration
Run the following to configure WSL from scratch...
```
bash -c "$(curl -fsSL https://raw.githubusercontent.com/randbrown/dotfiles/wsl/configure.sh)"
```
### WSL Emulator Install
Run the following command from an Administrator PowerShell prompt...
```
Set-ExecutionPolicy Bypass; iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/randbrown/dotfiles/wsl/wslterm.ps1'))
```
...
[Fork holman's](https://github.com/holman/dotfiles/fork) or [Fork jldeen's](htps://github.com/jldeen/dotfiles/fork) or [Fork mine](htps://github.com/randbrown/dotfiles/fork), remove what you don't
...
```sh
git clone https://github.com/randbrown/dotfiles.git ~/.dotfiles
cd ~/.dotfiles
script/bootstrap
```
